...
{
    public partial class FormGagueExpiring : Form
    {
        public static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public FormGagueExpiring()
        {
            InitializeComponent();
            init();
        }
        ...
        private void loadDG()
        {
            String sql = "select id, gage_id, gage_desc, gage_brand,  gage_rance, gage_slno, calib_due_date,clib_agency,gage_location  from t_gagues ";
            try
            {
                //date
