...
{
    public partial class FormEquipBorrowReturnHistory : Form
    {
        public static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);


        public FormEquipBorrowReturnHistory()
        {
            InitializeComponent();
            init();
        }
        ...
        private void loadDG()
        {
            String sql = "select id, equip_tag,  borrowed_by, returned_by, borrowed_on, returned_on, borrow_comments, return_comments,StatusStr,StatusRemark" +
                "  from t_equip_trans ";
            try
            {
